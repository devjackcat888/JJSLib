...
public class JJSTabBarButton: UIControl {
    ...
    open var highlightTextColor: UIColor? {
        didSet {
            if isSelected { titleLabel.textColor = highlightTextColor}
        }
    }
    ...
    open var itemContentMode: JJSTabBarButtonMode = .alwaysTemplate {
        didSet {
            updateDisplay()
        }
    }
    ...
    open override func layoutSubviews() {
        ...
        switch getWindow()?.windowScene?.interfaceOrientation {
